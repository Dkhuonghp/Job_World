...
<head>
    ...
    <!-- <link rel="stylesheet" href="css/jobs_box.css"> -->
    <!-- hamburger -->
    ...
    <script>
  // Get the modal
  var cv = document.getElementById('id05');
...
<nav class="navigation" id='nav'>
    ...
    <div class="logoImg" >
        <a href="job_02.php"><img src="img/logo.png" class="ImgHeader" width="250" height ="auto" alt=""></a>
    </div>  <!-- logo end -->
    <div id="menuToggle">
            ...
            <nav class="prefectureTopNavWrap">
                <ul class="prefectureTopBtnWrap">
                    <li class="prefectureTopBtnbox shadow">
                        <a onclick="document.getElementById('id01').style.display='block'" class="modalOpen modalArea">
                    ...
                    <li class="prefectureTopBtnbox shadow">
                        <a onclick="document.getElementById('id02').style.display='block'" class="modalOpen modalArea" class="modalOpen modalStation">
                    ...
                    <li class="prefectureTopBtnbox shadow">
                        <a onclick="document.getElementById('id03').style.display='block'" class="modalOpen modalOccupation">
                    ...
                    <li class="prefectureTopBtnbox shadow">
                        <a onclick="document.getElementById('id04').style.display='block'" class="modalOpen modalKodawari">
...
<section class="candy-wrapper">
                            ...
                            <div class="clearfix">
                                <div class="jobs_box_logo">
                                    <div class="jobs_box_logo_wrap">
                                        <a href="#"> <img src="img/img_06.jpg" alt=""> </a>
                                    </div>
                                </div>
                                <div class="jobs_table01">
                                    <table>
                                        <tbody>
                                            <tr>
                                                <th>
                                                    <span><?php echo $main ['localtion']?></span>
                                                </th>
                                                <td>
                                                    <p>
                                                        <a href="#">asia</a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <p>
                                                        <a href="#">depends on experience</a>
                                                    </p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>
                                                    <span><?php echo $main ['japanese lever']?></span>
                                                </th>
                                                <td>
                                                    <p>
                                                        <a href="#">Fluent(JLPT Lever1 or N1)</a>
                                                    </p>
                                                </td>
                                            </tr>
                                        </tbody>
                                ...
                                <div class="jobs_box_footer">
                                    ...
                                    <a href="詳細.php" class="btn08"><?php echo $main ['Details']?></a>
                    ...
                    <div class="jobs_box_content">
                        <div class="jobs_box_content_wrap">
                            <div class="clearfix">
                                ...
                                <div class="jobs_box_footer">
                                        <div class="btn_like" onclick="document.getElementById('id05').style.display='block'">
                                            <?php echo $main ['Apply']?>
                                        </div>
                                    <!-- đây là modal Apply -->
                                    <div id="id05" class="modal">
    ...
    </article><!-- Leave No Space --><aside class="sidebar fixedsticky wow wow slideInRight" data-wow-duration="2s" >
        <h2>quick search</h2>
